...
public class LoadScreen implements Screen {
    ...
    private Sprite logo, load, loadCont;
...
//    }
    ...
    public void show() {
        ...
        Texture texture = new Texture(Gdx.files.internal("start/fruitMonsterVintaLogoLoadingScreen.png"));
        texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);

        Texture texture1 = new Texture(Gdx.files.internal("start/FRUIT-MONSTER--Loading-screen-vinta-logo.png"));
    ...
    public void render(float delta) {
        ...
        game.assetManager.load("start/fruitMonsterVintaLogoLoadingScreen.png", Texture.class);
